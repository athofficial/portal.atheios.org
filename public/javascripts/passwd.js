function checkPass1()
{
    ...
    if(pass1.value.length > 5 && hasNumber(pass1.value)){
        pass1.style.backgroundColor = goodColor;
        //       message1.style.color = goodColor;
        message1.innerHTML = "Password: Well done!"
    }
    else{
        pass1.style.backgroundColor = badColor;
//        message1.style.color = badColor;
        message1.innerHTML = " Password: you have to enter at least 6 characters and contains atleast one numeric character!"
    }
}
